				...
				<div class="col-md-6">
					...
					<form action="" method="post" class="">
						...
						<div class="d-flex align-items-center">
							<label class="control control--checkbox mb-0"><span class="caption">Belum memiliki akun? Daftar</span>
								<span class="ml-auto"><a href="<?= base_url() ?>student/register" class="register"> disini!</a>
								</span>
							</label>
						</div>
					</form>
