<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	...
	<div class="btn-group mb-2 filter">
		<a role="button" class="btn btn-info dt-buton mb-2" href="<?= base_url() ?>staff/result/add">Add</a>
		<!-- </div> -->
			...
			<tbody>
				...
				foreach ($result as $res) : ?>
					<tr>
						...
						<td><?= $res['score']; ?></td>
						<td>
							<a role="button" class="btn btn-outline-success info sendEmail" href='<?= base_url() ?>staff/result/send/email?id=<?= $res['result_id']; ?>'>Send Result</a>
