<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	<h3 class="mt-3">Update Student Data</h3>
	<hr>
					...
					<div class="card-body">
						<form action="" method="post">
							...
							<div class="form-group mb-1">
								...
								<input type="text" class="form-control" name="student_id" id="studentID" placeholder="Student ID" value='<?= $std['student_id'] ?>' required>
							...
							<div class="form-group mb-1">
								...
								<input type="email" class="form-control" name="email" id="email" placeholder="E.g me@mail.com" value='<?= $std['email'] ?>' required>
								<?= form_error('email') ?>
							</div>

							<div class="form-group mb-1">
								<label for="password">Password</label>
								<input type="password" class="form-control" name="password" id="password" placeholder="Password" value='<?= $std['password'] ?>' required>
								<?= form_error('password') ?>
							</div>
