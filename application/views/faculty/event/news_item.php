		...
		<div class="row mt-2 post-header">
			<div class="col-lg-8 col-md-8">
				<div class="row">
					...
					<img src="<?= base_url() ?>assets/img/writing.jpg" class="img-fluid m-1 news-image">
				...
				<div class="row">
					...
					?>
						<div class="col-12 py-2 border-bottom-hidden">
							<div class="row">
								<div class="col-4"><a href="<?= base_url() ?>student/news/<?= $post['slug'] ?>"><img src="<?= base_url() ?>assets/img/pic (8).jpg" alt="<?= $post['slug'] ?>" class="img-fluid"></a></div>
